...
<img src="/images/blogs/latentlens/english-search.png" alt="Illustration of search steering from a red t-shirt query toward the same t-shirt in different colors" style="width:100%; max-width:860px; border-radius:12px; border:1px solid rgba(0,0,0,0.08); padding:8px; background:rgba(255,255,255,0.55);" />
